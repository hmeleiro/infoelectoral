...
At last, we may use [tmap](https://github.com/mtennekes/tmap) or even [ggplot](https://ggplot2.tidyverse.org/) to visualize the maps. In this case we  use the formar because of it's easier to create facets.
